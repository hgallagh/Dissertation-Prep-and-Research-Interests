...
\include{StatementofPurpose}
\include{Proposals/ResearchProposals}
\include{Course Notes/AngryRealAnalysis}
\include{Course Notes/DifferentialEquationsandLinearAlgebra}
